User.create!([
  {email: "tonggsy@gmail.com", encrypted_password: "$2a$10$Sk8Jm9DJbFeo3T/MewIKF.mELWywD4QZRxJPbfTHPZA4F1w0EqHXy", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 31, current_sign_in_at: "2015-10-10 09:24:34", last_sign_in_at: "2015-10-06 05:58:18", current_sign_in_ip: "::1", last_sign_in_ip: "::1", name: "Gloria Tong", role_id: 1},
  {email: "carly@ignitetalks.io", encrypted_password: "$2a$10$/N0ffwBysGudPIPKXOmgMu4WIxNn8gYsRVJC5NDZ3G7..qk8hxr1C", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 0, current_sign_in_at: nil, last_sign_in_at: nil, current_sign_in_ip: nil, last_sign_in_ip: nil, name: "Carly", role_id: 2},
  {email: "stephen@ignitetalks.io", encrypted_password: "$2a$10$jAwO5six230Xs83AjdY1E.Slw9.ZoIHUCVF7CyTxN9P3LMh2L2bGa", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: "2015-10-31 10:36:02", sign_in_count: 78, current_sign_in_at: "2015-10-31 10:36:02", last_sign_in_at: "2015-10-31 10:36:02", current_sign_in_ip: "::1", last_sign_in_ip: "::1", name: "Stephen Lead", role_id: 2}
])
...
Playlist.create!([
  {name: "blah", user_id: 10, event_id: 37, slug: "blah", featured: false, description: "Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Sed posuere consectetur est at lobortis. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Maecenas faucibus mollis interdum. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.", listed: nil},
  {name: "Top 10 technology talks", user_id: 9, event_id: 2, slug: "top-10-technology-talks", featured: true, description: "Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Cras mattis consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl consectetur et.", listed: true},
  {name: "Testing another playlist", user_id: 10, event_id: 30, slug: "testing-another-playlist", featured: false, description: "", listed: false},
  {name: "asdfasd", user_id: 9, event_id: 2, slug: "asdfasd", featured: false, description: "", listed: false}
])
Playlist::HABTM_Videos.create!([
  {playlist_id: 1, video_id: 2},
  {playlist_id: 1, video_id: 27},
  {playlist_id: 2, video_id: 20},
  {playlist_id: 3, video_id: 65},
  {playlist_id: 1, video_id: 22},
  {playlist_id: 1, video_id: 35}
])
Role.create!([
  {name: "regular"},
  {name: "admin"},
...
Tag.create!([
  ...
  {name: "cartoon", major: nil, slug: "cartoon"},
  {name: "girl", major: nil, slug: "girl"},
  {name: "life", major: nil, slug: "life"},
  {name: "books", major: nil, slug: "books"},
  {name: "geek", major: nil, slug: "geek"},
  {name: "gamers", major: nil, slug: "gamers"},
  {name: "entrepreneur", major: nil, slug: "entrepreneur"},
  {name: "business", major: nil, slug: "business"},
  {name: "honesty", major: nil, slug: "honesty"},
  {name: "parenting", major: nil, slug: "parenting"},
  {name: "science", major: true, slug: "science"},
  {name: "technology", major: true, slug: "technology"},
  {name: "work", major: true, slug: "work"},
  {name: "love", major: true, slug: "love"},
  {name: "health", major: true, slug: "health"},
  {name: "funny", major: true, slug: "funny"},
  {name: "culture", major: true, slug: "culture"},
  {name: "music", major: true, slug: "music"},
  {name: "test", major: nil, slug: "test"},
  {name: "cheese", major: nil, slug: "cheese"},
  {name: "corporate video", major: nil, slug: "corporate-video"},
  {name: "hunting with pixels", major: nil, slug: "hunting-with-pixels"},
  {name: "corporate video melbourne", major: nil, slug: "corporate-video-melbourne"},
  {name: "business video sydney", major: nil, slug: "business-video-sydney"},
  {name: "business video melbourne", major: nil, slug: "business-video-melbourne"},
  {name: "video marketing", major: nil, slug: "video-marketing"},
  {name: "video production sydney", major: nil, slug: "video-production-sydney"},
  {name: "video production melbourne", major: nil, slug: "video-production-melbourne"},
  {name: "Agency", major: nil, slug: "agency"},
  {name: "advertising", major: nil, slug: "advertising"},
  {name: "banjo advertising", major: nil, slug: "banjo-advertising"},
  {name: "18+", major: nil, slug: "18"}
])
Tag::HABTM_Videos.create!([
  ...
  {video_id: 9, tag_id: 2},
  {video_id: 9, tag_id: 3},
  {video_id: 10, tag_id: 2},
  {video_id: 10, tag_id: 4},
  {video_id: 11, tag_id: 8},
  {video_id: 11, tag_id: 9},
  {video_id: 13, tag_id: 15},
  {video_id: 13, tag_id: 17},
  {video_id: 13, tag_id: 11},
  {video_id: 15, tag_id: 15},
  {video_id: 16, tag_id: 16},
  {video_id: 16, tag_id: 12},
  {video_id: 16, tag_id: 8},
  {video_id: 17, tag_id: 15},
  {video_id: 17, tag_id: 17},
  {video_id: 17, tag_id: 8},
  {video_id: 18, tag_id: 19},
  {video_id: 18, tag_id: 9},
  {video_id: 19, tag_id: 20},
  {video_id: 20, tag_id: 8},
  {video_id: 21, tag_id: 2},
  {video_id: 21, tag_id: 21},
  {video_id: 22, tag_id: 9},
  {video_id: 22, tag_id: 13},
  {video_id: 22, tag_id: 22},
  {video_id: 23, tag_id: 9},
  {video_id: 26, tag_id: 15},
  {video_id: 27, tag_id: 15},
  {video_id: 27, tag_id: 20},
  {video_id: 30, tag_id: 4},
  {video_id: 30, tag_id: 21},
  {video_id: 30, tag_id: 1},
  {video_id: 32, tag_id: 9},
  {video_id: 33, tag_id: 3},
  {video_id: 33, tag_id: 9},
  {video_id: 33, tag_id: 21},
  {video_id: 33, tag_id: 1},
  {video_id: 34, tag_id: 20},
  {video_id: 35, tag_id: 15},
  {video_id: 35, tag_id: 9},
  {video_id: 37, tag_id: 3},
  {video_id: 37, tag_id: 21},
  {video_id: 37, tag_id: 1},
  {video_id: 38, tag_id: 15},
  {video_id: 38, tag_id: 9},
  {video_id: 38, tag_id: 1},
  {video_id: 39, tag_id: 15},
  {video_id: 39, tag_id: 9},
  {video_id: 40, tag_id: 15},
  {video_id: 40, tag_id: 1},
  {video_id: 41, tag_id: 15},
  {video_id: 42, tag_id: 15},
  {video_id: 42, tag_id: 3},
  {video_id: 42, tag_id: 21},
  {video_id: 43, tag_id: 15},
  {video_id: 43, tag_id: 19},
  {video_id: 43, tag_id: 9},
  {video_id: 43, tag_id: 13},
  {video_id: 43, tag_id: 2},
  {video_id: 47, tag_id: 1},
  {video_id: 47, tag_id: 5},
  {video_id: 48, tag_id: 12},
  {video_id: 48, tag_id: 5},
  {video_id: 48, tag_id: 1},
  {video_id: 48, tag_id: 11},
  {video_id: 49, tag_id: 2},
  {video_id: 49, tag_id: 11},
  {video_id: 40, tag_id: 10},
  {video_id: 6, tag_id: 3},
  {video_id: 47, tag_id: 12},
  {video_id: 50, tag_id: 3},
  {video_id: 50, tag_id: 19},
  {video_id: 50, tag_id: 9},
  {video_id: 50, tag_id: 22},
  {video_id: 51, tag_id: 12},
  {video_id: 51, tag_id: 5},
  {video_id: 51, tag_id: 21},
  {video_id: 51, tag_id: 1},
  {video_id: 51, tag_id: 11},
  {video_id: 52, tag_id: 5},
  {video_id: 52, tag_id: 1},
  {video_id: 52, tag_id: 11},
  {video_id: 53, tag_id: 4},
  {video_id: 53, tag_id: 12},
  {video_id: 53, tag_id: 5},
  {video_id: 53, tag_id: 2},
  {video_id: 53, tag_id: 21},
  {video_id: 53, tag_id: 1},
  {video_id: 54, tag_id: 3},
  {video_id: 54, tag_id: 21},
  {video_id: 55, tag_id: 4},
  {video_id: 55, tag_id: 3},
  {video_id: 55, tag_id: 19},
  {video_id: 55, tag_id: 9},
  {video_id: 55, tag_id: 2},
  {video_id: 56, tag_id: 15},
  {video_id: 56, tag_id: 19},
  {video_id: 56, tag_id: 21},
  {video_id: 57, tag_id: 15},
  {video_id: 57, tag_id: 4},
  {video_id: 57, tag_id: 19},
  {video_id: 57, tag_id: 9},
  {video_id: 2, tag_id: 1},
  {video_id: 2, tag_id: 4},
  {video_id: 3, tag_id: 2},
  {video_id: 3, tag_id: 3},
  ...
  {video_id: 57, tag_id: 19},
  {video_id: 57, tag_id: 9},
  {video_id: 60, tag_id: 10},
  {video_id: 64, tag_id: 1},
  {video_id: 65, tag_id: 23},
  {video_id: 65, tag_id: 24},
  {video_id: 69, tag_id: 36},
  {video_id: 69, tag_id: 38},
  {video_id: 69, tag_id: 39},
  {video_id: 69, tag_id: 40},
  {video_id: 69, tag_id: 41},
  {video_id: 69, tag_id: 42},
  {video_id: 69, tag_id: 43},
  {video_id: 70, tag_id: 44},
  {video_id: 70, tag_id: 45},
  {video_id: 70, tag_id: 46}
])
Upcoming.create!([
  {name: "Ignite Seattle 27", event_id: 1, date: "2015-06-18", user_id: 1, status: "published"},
  {name: "Ignite Cardiff 12", event_id: 3, date: "2015-12-25", user_id: 1, status: "published"},
  {name: "Ignite OKC 12", event_id: 19, date: "2015-08-17", user_id: 1, status: "published"},
  {name: "Ignite Fort Collins 18", event_id: 29, date: "2015-07-18", user_id: 1, status: "published"},
  {name: "Ignite Baltimore 17", event_id: 41, date: "2015-09-29", user_id: 7, status: "published"},
  {name: "Ignite Sydney 15", event_id: 2, date: "2015-10-20", user_id: 1, status: "published"},
  {name: "Ignite Brum 1", event_id: 42, date: "2015-10-27", user_id: 1, status: "published"}
])
Video.create!([
  ...
  {title: "Growing Up Assimilated", url: "https://www.youtube.com/watch?v=EMVAUl8aSqQ", event_id: 29, user_id: 1, slug: "growing-up-assimilated", speaker_name: "Gene Meier", speaker_url: "", status: "published", uid: "EMVAUl8aSqQ", likes: 1, dislikes: 0, views: 106, description: nil, featured: nil, hd: nil, R18: nil},
  {title: "Why I love the valleys", url: "https://www.youtube.com/watch?v=IxmxJPPKyxQ", event_id: 3, user_id: 1, slug: "why-i-love-the-valleys", speaker_name: "Mike Jordan", speaker_url: "", status: "published", uid: "IxmxJPPKyxQ", likes: 15, dislikes: 1, views: 1294, description: nil, featured: nil, hd: nil, R18: nil},
  {title: "Women with Swords or Blasters or Stakes", url: "https://www.youtube.com/watch?v=HnxzfPya7UU", event_id: 29, user_id: 1, slug: "women-with-swords-or-blasters-or-stakes", speaker_name: "Jana Knapp", speaker_url: "", status: "published", uid: "HnxzfPya7UU", likes: 0, dislikes: 0, views: 134, description: nil, featured: nil, hd: nil, R18: nil},
  ...
  {title: "What my Uncle Paul did one summer", url: "https://www.youtube.com/watch?v=MvOp_9Q17yI", event_id: 30, user_id: 1, slug: "what-my-uncle-paul-did-one-summer", speaker_name: "Caroline Ang", speaker_url: "", status: "published", uid: "MvOp_9Q17yI", likes: 8, dislikes: 0, views: 797, description: nil, featured: nil, hd: nil, R18: nil},
  {title: "Science is Real", url: "https://www.youtube.com/watch?v=vYepTH4A57I", event_id: 30, user_id: 1, slug: "science-is-real", speaker_name: "DJ Harry Moschop", speaker_url: "", status: "published", uid: "vYepTH4A57I", likes: 19, dislikes: 2, views: 1468, description: nil, featured: nil, hd: nil, R18: nil},
  ...
  {title: "The life of a skinny girl", url: "https://www.youtube.com/watch?v=qtTvTJdlbLY", event_id: 28, user_id: 1, slug: "the-life-of-a-skinny-girl", speaker_name: "Yasmine Mejri", speaker_url: "", status: "published", uid: "qtTvTJdlbLY", likes: 0, dislikes: 0, views: 95, description: nil, featured: nil, hd: nil, R18: nil},
  {title: "Save the planet, eat a bug", url: "https://www.youtube.com/watch?v=QSs27t8nPlM", event_id: 1, user_id: 1, slug: "save-the-planet-eat-a-bug", speaker_name: "Virginia Emery", speaker_url: "", status: "published", uid: "QSs27t8nPlM", likes: 4, dislikes: 0, views: 71, description: nil, featured: nil, hd: nil, R18: nil},
  {title: "Why the '8-Hour' Work Day is Total B.S.", url: "https://www.youtube.com/watch?v=SftL2UAaVmY", event_id: 29, user_id: 1, slug: "why-the-8-hour-work-day-is-total-b-s", speaker_name: "Nick Armstrong", speaker_url: "http://wtfmarketing.com/", status: "published", uid: "SftL2UAaVmY", likes: 24, dislikes: 0, views: 1784, description: nil, featured: nil, hd: nil, R18: nil},
